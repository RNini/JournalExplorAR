...
namespace Lean.Touch
{
	...
	public class LeanDragTranslate_FauxZoom : MonoBehaviour
	{
		...
		private void TranslateUI(Vector2 screenDelta)
		{
			...
			// Re-assign the values to flip the axes and remove the other transforms
			screenPoint = new Vector3(0, 0, screenPoint.y);
